...
const IPC = {
  ...
  DOCUMENTS_BATCH_DELETE: 'documents:batch-delete',
  DOCUMENTS_BATCH_EXPORT: 'documents:batch-export',
  DOCUMENTS_BATCH_UPDATE_CATEGORY: 'documents:batch-update-category',
...
const electronAPI = {
  ...
  batchDeleteDocuments: (ids: string[]) => ipcRenderer.invoke(IPC.DOCUMENTS_BATCH_DELETE, ids),
  batchExportDocuments: (ids: string[]) => ipcRenderer.invoke(IPC.DOCUMENTS_BATCH_EXPORT, ids),
  batchUpdateCategory: (ids: string[], category: string | null) =>
    ipcRenderer.invoke(IPC.DOCUMENTS_BATCH_UPDATE_CATEGORY, ids, category),
